...
var leaderboard_users_js_1 = require("./leaderboard-users.js");
...
function fetchLeaderboardData() {
    return __awaiter(this, void 0, void 0, function () {
        var url_1, response, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    url_1 = getUrlForIssue();
                    console.log(url_1);
...
function postLeaderboardData(data) {
    return __awaiter(this, void 0, void 0, function () {
        var url_2, response, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    url_2 = getUrlForIssue();
                    return [4 /*yield*/, fetch(url_2, {
                            method: 'POST',
                            headers: {
...
var statusButtonClick = function (id) {
    var _a;
    var statusBtn = document.getElementById(id);
    var parentId = ((_a = statusBtn === null || statusBtn === void 0 ? void 0 : statusBtn.parentNode) === null || _a === void 0 ? void 0 : _a.parentNode).id;
    var btnData = id.split('_');
    var user = users[parentId];
    var txt = 0;
    if (btnData[1] === 'like') {
        user.likes++;
        txt = user.likes;
    ...
    if (statusBtn instanceof HTMLButtonElement) {
        if (statusBtn.lastChild) {
            ...
            statusBtn.appendChild(document.createTextNode("".concat(txt)));
        }
        var stats = JSON.stringify(users, null, 2);
    }
};
var createButton = function (id, val) {
    ...
    button.id = id;
    button.onclick = function () { return statusButtonClick(button.id); };
    button.appendChild(img);
    button.appendChild(document.createTextNode("".concat(val)));
    return button;
};
/*
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (dataElement) {
                        formattedData.forEach(function (obj, i) {
                            var ext = '';
                            switch (obj.name) {
                                case 'BCQ': {
                                    ext = '8==D~~~';
                            ...
                            var s = "".concat(i + 1, ". ").concat(obj.name, " completed at ").concat(new Date(obj.created_at).toLocaleTimeString(), " ").concat(ext);
                            ...
                            users[newDiv.id] = new leaderboard_users_js_1.User(0, 0);
                        });
                    }
                    return [2 /*return*/];
            }
